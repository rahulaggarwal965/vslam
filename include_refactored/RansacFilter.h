...
class RansacFilter {
    ...
    public:
        ...
        RansacFilter(const int min_items = 8, const int max_iterations = 100, const float threshold = 0.02);
        ...
        int compute_fundamental_residual(cv::Mat *temp_F, std::vector<bool> *inliers);
